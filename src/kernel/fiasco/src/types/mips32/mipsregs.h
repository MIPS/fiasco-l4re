...
#define LINUX_MIPSREGS_FOR_FIASCO

#ifdef LINUX_MIPSREGS_FOR_FIASCO
...
#include <asm/war.h>
#endif /* LINUX_MIPSREGS_FOR_FIASCO */
...
#define MIPS_USERMODE(ps) (((ps) & ST0_KSU) == KSU_USER)
...
#ifdef LINUX_MIPSREGS_FOR_FIASCO
#define MIPS_CONF_VI		(_ULCAST_(1) <<	 3)    /* Virtual ICache if set */
#endif /* LINUX_MIPSREGS_FOR_FIASCO */
...
#ifdef LINUX_MIPSREGS_FOR_FIASCO
/* use "newval" instead of C++ "new" keyword in __BUILD_SET_C0 macros */
#endif /* LINUX_MIPSREGS_FOR_FIASCO */
