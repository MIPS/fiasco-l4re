/**
 * \file
 * \brief MIPS specific implementation of atomic functions
 */
/*
 ...
 */
#ifndef __L4UTIL__INCLUDE__ARCH_MIPS__ATOMIC_ARCH_H__
#define __L4UTIL__INCLUDE__ARCH_MIPS__ATOMIC_ARCH_H__
...
{
  l4_atomic_add((volatile long int *)dest, val);
}
...
{
  return l4_atomic_add((volatile long int *)dest, val);
}
...
#endif /* ! __L4UTIL__INCLUDE__ARCH_MIPS__ATOMIC_ARCH_H__ */
